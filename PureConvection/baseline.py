"""
PureConvection baseline: FNO trunk (:class:`FNOFluxBackbone1d`, modes default 32), same map as train.py.
"""
...
def main():
    ...
    ap.add_argument("--save", type=str, default="checkpoints/pureconvection_fno_flux_fixedstep.pt")
            ...
            torch.save(
                {
                    ...
                    "solver_bc": solver_bc,
                    "c": c_ref,
                    "kind": "pureconvection_fno_flux_fixedstep",
                    "state_rep": "u",
