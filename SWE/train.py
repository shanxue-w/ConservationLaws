"""
Train 1D SWE hybrid fixed-step map on conserved variables (HybridFixedStepMap1d, n_cons=2).
"""
...
def main():
    ...
    ap.add_argument("--save", type=str, default="checkpoints/swe_hybrid_fixedstep.pt")
