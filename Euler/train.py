"""
Train Euler hybrid fixed-step map on conserved variables (conslaw HybridFixedStepMap1d, n_cons=3).
"""
...
def main():
    ...
    ap.add_argument("--save", type=str, default="checkpoints/euler_hybrid_fixedstep.pt")
